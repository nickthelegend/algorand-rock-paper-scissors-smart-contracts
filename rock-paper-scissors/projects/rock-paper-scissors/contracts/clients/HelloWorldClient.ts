  ...
  readonly send = {
    ...
    create: {
      ...
      createApplication: async (params: CallParams<HelloWorldArgs['obj']['createApplication()void'] | HelloWorldArgs['tuple']['createApplication()void']> & AppClientCompilationParams & CreateSchema & SendParams & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
        ...
        return { result: { ...result.result, return: result.result.return as unknown as (undefined | HelloWorldReturns['createApplication()void']) }, appClient: new HelloWorldClient(result.appClient) }
      },
    },
